...
public class TTADSinformationExtension {

    @XmlElement(name = "LastUEActivityTime")
    protected XMLGregorianCalendar lastUEActivityTime;
     ...
     *     
     */
    public XMLGregorianCalendar getLastUEActivityTime() {
     ...
     *     
     */
    public void setLastUEActivityTime(XMLGregorianCalendar value) {
        this.lastUEActivityTime = value;
    }
